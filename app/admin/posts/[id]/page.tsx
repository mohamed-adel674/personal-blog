...
export default function PostEditor({ params }: PostEditorProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log("[v0] Post saved:", { title, slug, excerpt, content, category, tags, image: imageUrl })
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-foreground">{existingPost ? "Edit Post" : "Create Post"}</h1>
            </div>
          </div>
          <button
            form="post-form"
